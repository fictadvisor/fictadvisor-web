...
import GeneralTab from '@/components/templates/account-page/components/general-tab';
import GroupTab from '@/components/templates/account-page/components/group-tab';
import SecurityTab from '@/components/templates/account-page/components/security-tab';
import SelectiveTab from '@/components/templates/account-page/components/selective-tab';
import {
  AccountPagesMapper,
  AccountPageTab,
} from '@/components/templates/account-page/types';
