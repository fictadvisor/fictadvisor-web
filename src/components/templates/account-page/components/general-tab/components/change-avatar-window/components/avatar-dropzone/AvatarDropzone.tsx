...
import { handleFileSelect } from '@/components/templates/account-page/components/general-tab/components/change-avatar-window/components/avatar-dropzone/utils/handleFileSelect';
