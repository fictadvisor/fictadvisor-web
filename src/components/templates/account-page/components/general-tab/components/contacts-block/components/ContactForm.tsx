...
import {
  initialValues,
  validationSchema,
} from '@/components/templates/account-page/components/general-tab/components/contacts-block/validation';
import * as styles from '@/components/templates/account-page/components/general-tab/GeneralTab.styles';
