...
import ChangeAvatarWindow from '@/components/templates/account-page/components/general-tab/components/change-avatar-window';
import ContactsBlock from '@/components/templates/account-page/components/general-tab/components/contacts-block/ContactsBlock';
import PersonalInfoBlock from '@/components/templates/account-page/components/general-tab/components/personal-info';
import * as stylesMui from '@/components/templates/account-page/components/general-tab/GeneralTab.styles';
