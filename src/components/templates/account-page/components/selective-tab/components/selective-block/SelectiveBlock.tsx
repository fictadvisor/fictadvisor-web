...
import OpenedSelective from '@/components/templates/account-page/components/selective-tab/components/opened-selective';
import { fillArray } from '@/components/templates/account-page/components/selective-tab/components/selective-block/utils';
