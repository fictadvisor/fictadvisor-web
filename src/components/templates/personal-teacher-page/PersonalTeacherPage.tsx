...
import PersonalTeacherTabs from '@/components/templates/personal-teacher-page/personal-teacher-tabs';
import styles from '@/components/templates/personal-teacher-page/PersonalTeacherPage.module.scss';
import {
  PersonalTeacherPageProps,
  TeachersPageTabs,
} from '@/components/templates/personal-teacher-page/utils';
