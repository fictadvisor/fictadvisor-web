...
const CommentTab = dynamic(
  () =>
    import(
      '@/components/templates/personal-teacher-page/personal-teacher-tabs/components/comment-tab'
    ),
);
const GeneralTab = dynamic(
  () =>
    import(
      '@/components/templates/personal-teacher-page/personal-teacher-tabs/components/general-tab'
    ),
);
const PollButtons = dynamic(
  () =>
    import(
      '@/components/templates/personal-teacher-page/personal-teacher-tabs/components/poll-buttons'
    ),
);
const SubjectTab = dynamic(
  () =>
    import(
      '@/components/templates/personal-teacher-page/personal-teacher-tabs/components/subject-tab'
    ),
);
