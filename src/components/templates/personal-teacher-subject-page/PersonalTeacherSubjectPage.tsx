...
import PersonalSubjectTeacherTabs from '@/components/templates/personal-teacher-subject-page/personal-subject-teacher-tabs';
import styles from '@/components/templates/personal-teacher-subject-page/PersonalTeacherSubjectPage.module.scss';
