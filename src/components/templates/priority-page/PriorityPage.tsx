...
import {
  ...
  IPeduPrograms,
  ISTeduPrograms,
} from '@/components/templates/priority-page/constants';
import * as styles from '@/components/templates/priority-page/PriorityPage.styles';
import {
  getLocalStorage,
  saveLocalStorage,
} from '@/components/templates/priority-page/utils/localStorage';
import {
  optionalValidationSchema,
  validationSchema,
} from '@/components/templates/priority-page/validation';
