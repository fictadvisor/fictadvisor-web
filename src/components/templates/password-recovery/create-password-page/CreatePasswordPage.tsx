...
import CreatePasswordForm from '@/components/templates/password-recovery/create-password-page/components/create-password-form';
import * as styles from '@/components/templates/password-recovery/create-password-page/CreatePasswordPage.styles';
