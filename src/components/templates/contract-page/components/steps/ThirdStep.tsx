...
import { Actions } from '@/components/templates/contract-page/components/Actions';
import { kyiv } from '@/components/templates/contract-page/constants';
import { REGIONS } from '@/components/templates/contract-page/constants';
import * as stylesMui from '@/components/templates/contract-page/ContractPage.styles';
import { saveLocalStorage } from '@/components/templates/contract-page/utils/localStorage';
import {
  representativeOptionalValidation,
  representativeValidation,
} from '@/components/templates/contract-page/validation/representative';
