...
import CalendarInput from '@/components/templates/schedule-page/schedule-event-edit-section/schedule-form/components/calendar-input';
import { DisciplineRelatedFields } from '@/components/templates/schedule-page/schedule-event-edit-section/schedule-form/components/discipline-related-fields/DisciplineRelatedFields';
import { getOptionsFromDate } from '@/components/templates/schedule-page/schedule-event-edit-section/schedule-form/utils/getOptionsFromDate';
import { InfoCardTabs } from '@/components/templates/schedule-page/schedule-event-edit-section/types';
