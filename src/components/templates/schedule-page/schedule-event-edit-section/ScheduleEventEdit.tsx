...
import { formValidationSchema } from '@/components/templates/schedule-page/schedule-event-edit-section/schedule-form/validation';
import ScheduleInfoCard from '@/components/templates/schedule-page/schedule-event-edit-section/schedule-info-card';
import { prepareData } from '@/components/templates/schedule-page/schedule-event-edit-section/utils/prepareData';
import { transformDetailedEvent } from '@/components/templates/schedule-page/schedule-event-edit-section/utils/transformDetailedEvent';
