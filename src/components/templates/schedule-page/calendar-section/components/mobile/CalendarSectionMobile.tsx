...
import { GroupsDropDown } from '@/components/templates/schedule-page/calendar-section/components/groups-dropdown/GroupsDropDown';
import { CheckboxesDropdown } from '@/components/templates/schedule-page/calendar-section/components/mobile/checkboxes-dropdown/CheckboxesDropDown';
