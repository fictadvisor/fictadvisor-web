...
import ScheduleColumn from '@/components/templates/schedule-page/schedule-section/components/schedule/components/schedule-column/ScheduleColumn';
...
import ScheduleTime from '@/components/templates/schedule-page/schedule-section/components/schedule/components/schedule-time';
import { areDatesInSameWeek } from '@/components/templates/schedule-page/utils/areDatesInSameWeek';
