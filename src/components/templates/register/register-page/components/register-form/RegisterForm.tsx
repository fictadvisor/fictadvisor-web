...
import { RegisterFormFields } from '@/components/templates/register/register-page/components/register-form/types';
import {
  transformData,
  transformGroups,
} from '@/components/templates/register/register-page/components/register-form/utils';
