...
import { getPriorityName } from '@/components/templates/priority-approve-page/utils/getPriorityName';
import { getSpecialityName } from '@/components/templates/priority-approve-page/utils/getSpecialityName';
