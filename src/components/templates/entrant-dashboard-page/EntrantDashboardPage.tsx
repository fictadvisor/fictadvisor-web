...
import { ContractDetailsSection } from '@/components/templates/entrant-dashboard-page/components/ContractDetailsSection';
import { ContractPersonalDetailsSection } from '@/components/templates/entrant-dashboard-page/components/ContractPersonalDetailsSection';
import { PersonalDataSection } from '@/components/templates/entrant-dashboard-page/components/PersonalDataSection';
import { PrioritiesSection } from '@/components/templates/entrant-dashboard-page/components/PrioritiesSection';
import * as styles from '@/components/templates/entrant-dashboard-page/EntrantDashboardPage.styles';
